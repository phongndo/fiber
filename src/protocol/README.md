...
It does not open sockets, discover sessions, dispatch core commands, or perform terminal I/O. Every
...
The present single-client format is intentionally unversioned. Add version and capability
